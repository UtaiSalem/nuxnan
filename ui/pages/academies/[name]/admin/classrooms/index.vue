...
<template>
  <div class="px-4 sm:px-0">
    ...
    <div v-else class="space-y-6">
      ...
      <div v-else-if="classrooms.length === 0" class="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-12 text-center shadow-sm border border-gray-100 dark:border-gray-700">
