...
const handleSubmit = async () => {
  if (!validateForm() || !academyId.value) return
  ...
  try {
    ...
    const response: any = await api.post(`/api/academies/${academyId.value}/courses`, formData)
...
<template>
  <div class="space-y-6 max-w-3xl mx-auto">
    ...
    <div class="flex items-center gap-4">
      ...
      <div>
        <h1 class="text-2xl font-bold text-gray-800 dark:text-white">สร้างรายวิชาใหม่</h1>
        <p class="text-gray-500 dark:text-gray-400 mt-1">กรอกข้อมูลเพื่อสร้างรายวิชา</p>
      </div>
    </div>
    ...
    <form @submit.prevent="handleSubmit" class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 space-y-6">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          ...
          <select
            v-model="form.level"
            class="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl text-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500"
          >
      ...
      <div>
        ...
        <div class="flex items-center gap-4">
          <label class="flex-1 flex flex-col items-center justify-center p-6 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl cursor-pointer hover:border-primary-500 dark:hover:border-primary-400 transition-colors">
      ...
      <div class="flex flex-col sm:flex-row gap-3 pt-4">
        <button
          ...
          class="flex-1 inline-flex justify-center items-center gap-2 px-6 py-3 bg-primary-600 hover:bg-primary-700 disabled:bg-primary-400 rounded-xl text-white font-medium transition-colors"
        >
