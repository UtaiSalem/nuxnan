  ...
  <div>
    <MainLayout title="Support Plearnd.com">
      <template #coverProfileCard>
        <div
          class="hidden md:flex items-center max-w-7xl mx-auto jusb mt-2 shadow-lg bg-cover bg-no-repeat rounded-lg overflow-hidden"
            ...
            <div class="grid grid-cols-1 gap-4 mt-4">
              <div>
                <p class="block text-gray-700 dark:text-white mb-1">
                  จำนวนครั้งที่ผู้ใช้สามารถกดรับและแสดงผลสื่อประชาสัมพันธ์สินค้า
                </p>
                <p
