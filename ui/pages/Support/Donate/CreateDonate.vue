...
const totalMoneySupportOptions = ref([
  ...tempDonate2Digit.value,
  ...tempDonate3Digit.value,
  ...tempDonate4Digit.value,
])
...
async function submitForm(e) {
  ...
  donateInfo.append(
    'transfer_time',
    transferTime.value['hours'] + ':' + transferTime.value['minutes']
  )
...
<template>
  <div>
    ...
    <div class="mx-4">
      <div
        class="flex items-center justify-between max-w-7xl mx-auto mt-2 mb-4 shadow-lg bg-cover bg-no-repeat rounded-lg overflow-hidden"
      ...
      >
        ...
        <div class="flex">
          <Link href="/" class="text-xl font-bold text-white mx-2 underline flex items-center"
            ><Icon icon="heroicons-solid:home" />Home</Link
          >
          <Link
            href="/play/newsfeed"
            class="text-xl font-bold text-white mx-2 underline flex items-center"
            ><Icon icon="heroicons:newspaper-solid" />กระดานข่าว</Link
          >
        </div>
      </div>
    </div>
    ...
    <div class="flex flex-row items-center justify-center mb-4">
      <div class="max-w-xl plearnd-card">
        ...
        <h2 class="mb-2 text-xl font-semibold text-gray-700 dark:text-white">ข้อมูลการสนับสนุน</h2>
        <div class="px-6">
        ...
        >
          <div class="grid grid-cols-1 gap-4 mt-4">
            <div class="mb-2" v-if="!refDonor">
              <label for="personal_code" class="block mb-2 font-medium text-gray-700"
            ...
            <h3 class="text-xl font-semibold text-gray-700 dark:text-white" v-if="refDonor">
              ผู้สนับสนุนทุนการเรียนรู้
            </h3>
            ...
            <figure
              v-if="refDonor && !isLoadingDonor"
              class="relative flex p-2 mb-4 bg-gray-300 rounded-md"
            >
              <button
                @click.prevent="handleEmptyDonor"
                class="absolute top-0 right-0 p-1 m-2 bg-white rounded-full opacity-60"
              >
              ...
              <div class="flex-shrink-0">
                <img
                  ...
                  :src="refDonor.profile_photo_url"
              ...
              <div class="ps-3">
                <div
                  class="mb-1 md:space-x-2 text-sm text-gray-700 dark:text-gray-400 flex flex-col md:flex-row md:items-center"
                >
                ...
                <Link
                  :href="refDonor.referal_link"
                  class="text-base text-white bg-teal-500 py-1 px-4 rounded-lg"
                >
                  สมัครต่อ
                </Link>
              </div>
            ...
            <div>
              ...
              >
                <option
                  v-for="(moneyOption, midx) in totalMoneySupportOptions"
                  :key="midx"
                  :value="midx"
          ...
          <div class="grid grid-cols-1 gap-4 mt-4" v-if="!slipImage">
            ...
            >
              <div class="text-center">
                <img
                  class="w-8 h-8 mx-auto opacity-70"
                ...
                <p class="mt-1 text-xs text-gray-500">PNG, JPG, GIF up to 4MB</p>
              </div>
            </div>
          </div>
          <div class="grid grid-cols-1 mt-4">
            <p class="block mb-1 text-gray-700 dark:text-white">วัน/เวลา ที่ทำรายการ</p>
          </div>
