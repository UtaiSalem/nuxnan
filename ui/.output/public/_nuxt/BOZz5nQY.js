import{_ as X}from"./BP2gnDQ3.js";import{x as Y,c as l,a as t,b as o,w as Z,u as r,e as _,t as d,F as P,k as U,$ as ee,aa as te,d as I,r as M,n as O,G as se,o as i,I as n,T as F,ac as ae}from"./Brb_7992.js";import{S as f}from"./BQxta0Da.js";const re={class:"p-6 space-y-6"},oe={class:"flex items-center justify-between"},ne={class:"bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-4"},le={class:"flex items-start gap-3"},ie={class:"text-sm text-blue-700 dark:text-blue-300"},de={class:"list-disc list-inside space-y-1 text-blue-600 dark:text-blue-400"},ce={class:"bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 space-y-4"},ge={class:"flex flex-wrap gap-2"},ue=["onClick"],xe={class:"flex gap-3"},be={class:"flex-1 relative"},pe={class:"absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none"},me=["placeholder"],ye={key:0,class:"space-y-4"},fe={class:"flex items-center justify-between"},ve={class:"text-lg font-semibold text-gray-900 dark:text-white"},he={class:"grid grid-cols-1 lg:grid-cols-2 gap-4"},we={class:"h-16 bg-gradient-to-r from-teal-400 via-teal-500 to-blue-500 relative"},ke={class:"absolute -bottom-8 left-4"},_e={class:"w-16 h-16 rounded-full border-4 border-white dark:border-gray-800 overflow-hidden bg-white shadow-lg"},$e=["src","alt"],Se={class:"absolute top-2 right-2 px-2 py-1 bg-white/20 backdrop-blur rounded text-xs text-white font-medium"},Le={class:"pt-10 px-4 pb-4 space-y-4"},Te=["innerHTML"],Ce=["innerHTML"],Be={class:"flex flex-wrap gap-2"},Pe={key:0,class:"inline-flex items-center gap-1 px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded text-xs text-gray-600 dark:text-gray-400"},Me=["innerHTML"],je={key:1,class:"inline-flex items-center gap-1 px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded text-xs text-gray-600 dark:text-gray-400"},We=["innerHTML"],Ne={class:"p-3 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 rounded-lg border border-amber-200 dark:border-amber-800"},De={class:"flex items-center justify-between"},Ee={class:"flex items-center gap-2"},Ie={class:"flex items-center gap-2"},He={class:"font-bold text-green-600 dark:text-green-400"},Re={class:"font-bold text-gray-600 dark:text-gray-400"},Ae={class:"space-y-2"},Ve={key:0},Ue={class:"flex items-center gap-2 text-green-600 dark:text-green-400 text-sm mb-2"},Oe=["onClick"],Fe={class:"flex items-center gap-2 text-blue-600 dark:text-blue-400 text-sm mb-2"},ze=["onClick"],Qe={key:1},Ge={class:"flex items-center gap-2 text-red-600 dark:text-red-400 text-sm mb-2"},qe=["onClick"],Je={key:1,class:"bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-12 text-center"},Ke={key:2,class:"bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-12 text-center"},Xe={class:"text-sm text-gray-500 dark:text-gray-400"},Ye={key:3,class:"bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-12 text-center"},b=4800,h=1080,at={__name:"Resetpassword",setup(Ze){const{$apiFetch:j}=Y(),c=M(""),p=se([]),T=M(!1),$=M("all"),S=M(!1),W=[{value:"all",label:"ทั้งหมด",icon:"mdi:magnify"},{value:"email",label:"อีเมล",icon:"mdi:email"},{value:"name",label:"ชื่อ",icon:"mdi:account"},{value:"phone",label:"เบอร์โทร",icon:"mdi:phone"},{value:"code",label:"รหัสประจำตัว",icon:"mdi:card-account-details"}],z=O(()=>W.find(s=>s.value===$.value)||W[0]),Q=O(()=>{const s={all:"ค้นหาด้วย อีเมล, ชื่อ, เบอร์โทร หรือรหัสประจำตัว",email:"กรอกอีเมลที่ต้องการค้นหา",name:"กรอกชื่อที่ต้องการค้นหา",phone:"กรอกเบอร์โทรที่ต้องการค้นหา",code:"กรอกรหัสประจำตัวที่ต้องการค้นหา"};return s[$.value]||s.all});function w(s){return s.points??0}function C(s){return s.wallet??0}function N(s){const e=w(s),g=C(s)*h;return e+g}function H(s){return N(s)>=b}function R(s){const e=w(s);return Math.min(e,b)}function D(s){const e=w(s),g=Math.max(0,b-e);return Math.ceil(g/h)}function A(s){const e=N(s);return Math.max(0,b-e)}function G(s){return Math.ceil(A(s)/h)}const L=ae(async()=>{if(!c.value.trim()){p.value=[],S.value=!1;return}try{T.value=!0,S.value=!0;const s=await j("/api/forgot-password/getuser",{method:"POST",body:{email:c.value.trim(),search_type:$.value}});s?.users?p.value=structuredClone(s.users):p.value=[]}catch(s){console.error("Search error:",s),p.value=[]}finally{T.value=!1}},400);async function V(s){const e=document.documentElement.classList.contains("dark"),g=w(s),a=C(s),y=R(s),v=D(s);let k="";v>0?k=`
