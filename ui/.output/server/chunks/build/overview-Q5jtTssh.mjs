...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen py-8 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-900" }, _attrs))}><div class="max-w-4xl mx-auto"><div class="text-center mb-8"><div class="w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full flex items-center justify-center shadow-lg">`);
      _push(ssrRenderComponent(unref(Icon), {
        name: "mdi:view-dashboard-outline",
        class: "w-10 h-10 text-white"
      }, null, _parent));
      _push(`</div><h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2"> \u0E20\u0E32\u0E1E\u0E23\u0E27\u0E21 </h1><p class="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto"> \u0E14\u0E39\u0E20\u0E32\u0E1E\u0E23\u0E27\u0E21\u0E01\u0E34\u0E08\u0E01\u0E23\u0E23\u0E21\u0E41\u0E25\u0E30\u0E2A\u0E16\u0E34\u0E15\u0E34\u0E15\u0E48\u0E32\u0E07\u0E46 \u0E02\u0E2D\u0E07\u0E04\u0E38\u0E13\u0E1A\u0E19\u0E41\u0E1E\u0E25\u0E15\u0E1F\u0E2D\u0E23\u0E4C\u0E21 </p></div>`);
      _push(ssrRenderComponent(_component_BaseCard, { class: "text-center py-12" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-2"${_scopeId}> \u0E40\u0E23\u0E47\u0E27\u0E46 \u0E19\u0E35\u0E49 </h2><p class="text-gray-600 dark:text-gray-400"${_scopeId}> \u0E2B\u0E19\u0E49\u0E32\u0E20\u0E32\u0E1E\u0E23\u0E27\u0E21\u0E01\u0E33\u0E25\u0E31\u0E07\u0E2D\u0E22\u0E39\u0E48\u0E23\u0E30\u0E2B\u0E27\u0E48\u0E32\u0E07\u0E01\u0E32\u0E23\u0E1E\u0E31\u0E12\u0E19\u0E32 \u0E01\u0E23\u0E38\u0E13\u0E32\u0E23\u0E2D\u0E15\u0E34\u0E14\u0E15\u0E32\u0E21\u0E01\u0E32\u0E23\u0E2D\u0E31\u0E1B\u0E40\u0E14\u0E15 </p>`);
          } else {
            return [
              ...
              createVNode("p", { class: "text-gray-600 dark:text-gray-400" }, " \u0E2B\u0E19\u0E49\u0E32\u0E20\u0E32\u0E1E\u0E23\u0E27\u0E21\u0E01\u0E33\u0E25\u0E31\u0E07\u0E2D\u0E22\u0E39\u0E48\u0E23\u0E30\u0E2B\u0E27\u0E48\u0E32\u0E07\u0E01\u0E32\u0E23\u0E1E\u0E31\u0E12\u0E19\u0E32 \u0E01\u0E23\u0E38\u0E13\u0E32\u0E23\u0E2D\u0E15\u0E34\u0E14\u0E15\u0E32\u0E21\u0E01\u0E32\u0E23\u0E2D\u0E31\u0E1B\u0E40\u0E14\u0E15 ")
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=overview-Q5jtTssh.mjs.map
