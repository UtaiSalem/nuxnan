      ...
      _push(ssrRenderComponent(_component_BaseCard, { class: "text-center py-12" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-2"${_scopeId}> \u0E40\u0E23\u0E47\u0E27\u0E46 \u0E19\u0E35\u0E49 </h2><p class="text-gray-600 dark:text-gray-400"${_scopeId}> \u0E2B\u0E19\u0E49\u0E32\u0E2A\u0E21\u0E32\u0E0A\u0E34\u0E01\u0E01\u0E33\u0E25\u0E31\u0E07\u0E2D\u0E22\u0E39\u0E48\u0E23\u0E30\u0E2B\u0E27\u0E48\u0E32\u0E07\u0E01\u0E32\u0E23\u0E1E\u0E31\u0E12\u0E19\u0E32 \u0E01\u0E23\u0E38\u0E13\u0E32\u0E23\u0E2D\u0E15\u0E34\u0E14\u0E15\u0E32\u0E21\u0E01\u0E32\u0E23\u0E2D\u0E31\u0E1B\u0E40\u0E14\u0E15 </p>`);
          } else {
            return [
              ...
              createVNode("p", { class: "text-gray-600 dark:text-gray-400" }, " \u0E2B\u0E19\u0E49\u0E32\u0E2A\u0E21\u0E32\u0E0A\u0E34\u0E01\u0E01\u0E33\u0E25\u0E31\u0E07\u0E2D\u0E22\u0E39\u0E48\u0E23\u0E30\u0E2B\u0E27\u0E48\u0E32\u0E07\u0E01\u0E32\u0E23\u0E1E\u0E31\u0E12\u0E19\u0E32 \u0E01\u0E23\u0E38\u0E13\u0E32\u0E23\u0E2D\u0E15\u0E34\u0E14\u0E15\u0E32\u0E21\u0E01\u0E32\u0E23\u0E2D\u0E31\u0E1B\u0E40\u0E14\u0E15 ")
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=members-DfOuMJVP.mjs.map
