...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="w-full sm:max-w-2xl mt-6 p-6 bg-white shadow-md overflow-hidden sm:rounded-lg prose">${(_a = __props.policy) != null ? _a : ""}</div></div></div></div><!--]-->`);
    };
  }
};
...
//# sourceMappingURL=PrivacyPolicy-BL6iPH7K.mjs.map
