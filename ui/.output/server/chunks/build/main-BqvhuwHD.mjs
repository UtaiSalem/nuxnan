...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-7a503094><header class="${ssrRenderClass([
      ...
      ])}" data-v-7a503094><div class="h-full px-4 flex items-center justify-between gap-4" data-v-7a503094><div class="flex items-center gap-3" data-v-7a503094><button class="hidden lg:flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-vikinger-purple to-vikinger-cyan shadow-vikinger hover:shadow-vikinger-lg transition-all duration-300 hover:scale-110 group relative overflow-hidden" data-v-7a503094><div class="absolute inset-0 bg-white/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300" data-v-7a503094></div><div class="relative flex flex-col gap-1 w-5" data-v-7a503094><span class="${ssrRenderClass([isLeftDrawerOpen.value ? "rotate-45 translate-y-1.5" : "", "h-0.5 bg-white rounded-full transition-all duration-300"])}" data-v-7a503094></span><span class="${ssrRenderClass([isLeftDrawerOpen.value ? "opacity-0 scale-0" : "", "h-0.5 bg-white rounded-full transition-all duration-300"])}" data-v-7a503094></span><span class="${ssrRenderClass([isLeftDrawerOpen.value ? "-rotate-45 -translate-y-1.5" : "", "h-0.5 bg-white rounded-full transition-all duration-300"])}" data-v-7a503094></span></div></button><button class="lg:hidden flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-vikinger-purple to-vikinger-cyan shadow-md hover:shadow-lg transition-all duration-300 hover:scale-110 group relative overflow-hidden" data-v-7a503094><div class="absolute inset-0 bg-white/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300" data-v-7a503094></div><div class="relative flex flex-col gap-1 w-5" data-v-7a503094><span class="${ssrRenderClass([isMobileSidebarOpen.value ? "rotate-45 translate-y-1.5" : "", "h-0.5 bg-white rounded-full transition-all duration-300"])}" data-v-7a503094></span><span class="${ssrRenderClass([isMobileSidebarOpen.value ? "opacity-0 scale-0" : "", "h-0.5 bg-white rounded-full transition-all duration-300"])}" data-v-7a503094></span><span class="${ssrRenderClass([isMobileSidebarOpen.value ? "-rotate-45 -translate-y-1.5" : "", "h-0.5 bg-white rounded-full transition-all duration-300"])}" data-v-7a503094></span></div></button>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} alt="Plearnd Logo" class="w-10 h-10" data-v-7a503094${_scopeId}><span class="hidden md:inline-block px-3 py-1 text-lg font-audiowide text-white rounded-lg bg-gradient-vikinger shadow-lg" data-v-7a503094${_scopeId}>NUXNAN</span>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
      ...
      _push(`</div><div class="hidden md:flex items-center gap-2" data-v-7a503094><!--[-->`);
      ssrRenderList(navigation, (item) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          key: item.href,
          to: item.href,
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<span class="hidden xl:inline" data-v-7a503094${_scopeId}>${ssrInterpolate(item.name)}</span>`);
            } else {
              return [
                createVNode(unref(Icon), {
                  icon: item.icon,
      ...
      _push(`<!--]--></div><div class="flex items-center gap-2" data-v-7a503094>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/earn/points",
        class: [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="w-6 h-6 rounded-lg bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center" data-v-7a503094${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Icon), {
              icon: "fluent:star-24-filled",
              class: "w-3.5 h-3.5 text-white"
            }, null, _parent2, _scopeId));
            _push2(`</div><span class="${ssrRenderClass([isDarkMode.value ? "text-amber-400" : "text-amber-600", "font-bold text-sm"])}" data-v-7a503094${_scopeId}>${ssrInterpolate(formatNumber(authUser.value.pp))}</span>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="w-6 h-6 rounded-lg bg-gradient-to-br from-emerald-400 to-green-500 flex items-center justify-center" data-v-7a503094${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Icon), {
              icon: "fluent:money-24-filled",
              class: "w-3.5 h-3.5 text-white"
            }, null, _parent2, _scopeId));
            _push2(`</div><span class="${ssrRenderClass([isDarkMode.value ? "text-emerald-400" : "text-emerald-600", "font-bold text-sm"])}" data-v-7a503094${_scopeId}> \u0E3F${ssrInterpolate(formatNumber(authUser.value.wallet))}</span>`);
          } else {
            return [
      ...
      ])}" title="\u0E2A\u0E41\u0E01\u0E19 QR Code" data-v-7a503094>`);
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="w-10 h-10 rounded-full overflow-hidden border-2 border-vikinger-cyan shadow-lg group-hover:border-vikinger-purple group-hover:scale-110 transition-all" data-v-7a503094${_scopeId}><img${ssrRenderAttr("src", authUser.value.profile_photo_url)}${ssrRenderAttr("alt", authUser.value.name)} class="w-full h-full object-cover" data-v-7a503094${_scopeId}></div>`);
          } else {
            return [
      ...
      ])}"${ssrRenderAttr("title", isDarkMode.value ? "Switch to Light Mode" : "Switch to Dark Mode")} data-v-7a503094>`);
      if (isDarkMode.value) {
        _push(ssrRenderComponent(unref(Icon), {
      ...
      _push(`</button><div class="relative" data-v-7a503094><button class="${ssrRenderClass([
      ...
      if (isSettingsOpen.value) {
        ...
        ])}" data-v-7a503094><div class="py-2" data-v-7a503094>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/profile",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<span data-v-7a503094${_scopeId}>\u0E42\u0E1B\u0E23\u0E44\u0E1F\u0E25\u0E4C</span>`);
            } else {
              return [
                createVNode(unref(Icon), {
                  icon: "fluent:person-24-regular",
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<span data-v-7a503094${_scopeId}>\u0E15\u0E31\u0E49\u0E07\u0E04\u0E48\u0E32</span>`);
            } else {
              return [
                createVNode(unref(Icon), {
                  icon: "fluent:settings-24-regular",
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<span data-v-7a503094${_scopeId}>\u0E01\u0E32\u0E23\u0E41\u0E08\u0E49\u0E07\u0E40\u0E15\u0E37\u0E2D\u0E19</span>`);
            } else {
              return [
                createVNode(unref(Icon), {
                  icon: "fluent:alert-24-regular",
        ...
        if (authUser.value.is_plearnd_admin) {
          _push(`<div class="${ssrRenderClass([isDarkMode.value ? "border-vikinger-dark-50/30" : "border-gray-200", "border-t my-1"])}" data-v-7a503094></div>`);
        } else {
          _push(`<!---->`);
        }
        if (authUser.value.is_plearnd_admin) {
          _push(`<div class="${ssrRenderClass([isDarkMode.value ? "text-gray-500" : "text-gray-400", "px-4 py-2 text-xs font-semibold uppercase tracking-wider"])}" data-v-7a503094> \u0E40\u0E21\u0E19\u0E39\u0E1C\u0E39\u0E49\u0E14\u0E39\u0E41\u0E25\u0E23\u0E30\u0E1A\u0E1A </div>`);
        } else {
          _push(`<!---->`);
        }
        if (authUser.value.is_plearnd_admin) {
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                _push2(`<span data-v-7a503094${_scopeId}>\u0E2D\u0E19\u0E38\u0E21\u0E31\u0E15\u0E34\u0E01\u0E32\u0E23\u0E2A\u0E19\u0E31\u0E1A\u0E2A\u0E19\u0E38\u0E19</span>`);
              } else {
                return [
                  createVNode(unref(Icon), {
                    icon: "mdi:hand-coin",
          ...
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                _push2(`<span data-v-7a503094${_scopeId}>\u0E23\u0E35\u0E40\u0E0B\u0E47\u0E15\u0E23\u0E2B\u0E31\u0E2A\u0E1C\u0E48\u0E32\u0E19</span>`);
              } else {
                return [
                  createVNode(unref(Icon), {
                    icon: "mdi:lock-reset",
          ...
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                _push2(`<span data-v-7a503094${_scopeId}>\u0E08\u0E31\u0E14\u0E01\u0E32\u0E23\u0E01\u0E32\u0E23\u0E2A\u0E19\u0E31\u0E1A\u0E2A\u0E19\u0E38\u0E19</span>`);
              } else {
                return [
                  createVNode(unref(Icon), {
                    icon: "mdi:hand-heart",
        ...
        _push(`<div class="${ssrRenderClass([isDarkMode.value ? "border-vikinger-dark-50/30" : "border-gray-200", "border-t my-1"])}" data-v-7a503094></div><button class="w-full flex items-center gap-3 px-4 py-3 transition-colors text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20" data-v-7a503094>`);
        _push(ssrRenderComponent(unref(Icon), {
          icon: "fluent:sign-out-24-regular",
          class: "w-5 h-5"
        }, null, _parent));
        _push(`<span data-v-7a503094>\u0E2D\u0E2D\u0E01\u0E08\u0E32\u0E01\u0E23\u0E30\u0E1A\u0E1A</span></button></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (isSettingsOpen.value) {
        _push(`<div class="fixed inset-0 z-40" data-v-7a503094></div>`);
      } else {
        _push(`<!---->`);
      }
      ...
      if (!isRightDrawerOpen.value) {
        _push(`<div class="absolute inset-0 bg-white/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300" data-v-7a503094></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(ssrRenderComponent(unref(Icon), {
      ...
      _push(`</button></div></div></header><div class="pt-16 flex min-h-screen" data-v-7a503094><aside class="${ssrRenderClass([
      ...
      if (isLeftDrawerOpen.value) {
        _push(`<div class="p-6 space-y-6" data-v-7a503094><div class="text-center" data-v-7a503094><div class="relative inline-block mb-4" data-v-7a503094><img${ssrRenderAttr("src", authUser.value.profile_photo_url)} class="w-24 h-24 rounded-full border-4 border-vikinger-purple shadow-lg"${ssrRenderAttr("alt", authUser.value.name)} data-v-7a503094><div class="${ssrRenderClass([isDarkMode.value ? "border-vikinger-dark-100" : "border-white", "absolute -bottom-2 -right-2 w-10 h-10 bg-gradient-vikinger rounded-full flex items-center justify-center text-white font-bold border-4 transition-colors duration-300"])}" data-v-7a503094>${ssrInterpolate(authUser.value.level)}</div></div><h3 class="${ssrRenderClass([isDarkMode.value ? "text-white" : "text-gray-900", "text-xl font-bold"])}" data-v-7a503094>${ssrInterpolate(authUser.value.name)}</h3><p class="${ssrRenderClass([isDarkMode.value ? "text-gray-400" : "text-gray-600", "text-sm"])}" data-v-7a503094>${ssrInterpolate(authUser.value.email)}</p></div><div class="flex justify-center gap-2" data-v-7a503094><div class="w-10 h-10 bg-yellow-500 rounded-lg flex items-center justify-center" data-v-7a503094>`);
        _push(ssrRenderComponent(unref(Icon), {
          icon: "fluent:trophy-24-filled",
          class: "w-6 h-6 text-white"
        }, null, _parent));
        _push(`</div><div class="w-10 h-10 bg-vikinger-purple rounded-lg flex items-center justify-center" data-v-7a503094>`);
        _push(ssrRenderComponent(unref(Icon), {
          icon: "fluent:shield-checkmark-24-filled",
          class: "w-6 h-6 text-white"
        }, null, _parent));
        _push(`</div><div class="w-10 h-10 bg-green-500 rounded-lg flex items-center justify-center" data-v-7a503094>`);
        _push(ssrRenderComponent(unref(Icon), {
          icon: "fluent:checkmark-circle-24-filled",
          class: "w-6 h-6 text-white"
        }, null, _parent));
        _push(`</div><div class="w-10 h-10 bg-blue-500 rounded-lg flex items-center justify-center" data-v-7a503094>`);
        _push(ssrRenderComponent(unref(Icon), {
          icon: "fluent:star-24-filled",
          class: "w-6 h-6 text-white"
        }, null, _parent));
        _push(`</div></div><div class="${ssrRenderClass([isDarkMode.value ? "border-vikinger-dark-50/30" : "border-gray-200", "grid grid-cols-3 gap-4 text-center py-4 border-y transition-colors duration-300"])}" data-v-7a503094><div data-v-7a503094><div class="${ssrRenderClass([isDarkMode.value ? "text-white" : "text-gray-900", "text-2xl font-bold"])}" data-v-7a503094>${ssrInterpolate(authUser.value.posts)}</div><div class="${ssrRenderClass([isDarkMode.value ? "text-gray-400" : "text-gray-600", "text-xs uppercase"])}" data-v-7a503094> \u0E42\u0E1E\u0E2A\u0E15\u0E4C </div></div><div data-v-7a503094><div class="${ssrRenderClass([isDarkMode.value ? "text-white" : "text-gray-900", "text-2xl font-bold"])}" data-v-7a503094>${ssrInterpolate(authUser.value.friends)}</div><div class="${ssrRenderClass([isDarkMode.value ? "text-gray-400" : "text-gray-600", "text-xs uppercase"])}" data-v-7a503094> \u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E19 </div></div><div data-v-7a503094><div class="${ssrRenderClass([isDarkMode.value ? "text-white" : "text-gray-900", "text-2xl font-bold"])}" data-v-7a503094>${ssrInterpolate(authUser.value.visits)}</div><div class="${ssrRenderClass([isDarkMode.value ? "text-gray-400" : "text-gray-600", "text-xs uppercase"])}" data-v-7a503094> \u0E40\u0E22\u0E35\u0E48\u0E22\u0E21\u0E0A\u0E21 </div></div></div><div class="space-y-1" data-v-7a503094>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/dashboard",
          class: [
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<span class="font-semibold" data-v-7a503094${_scopeId}>\u0E41\u0E14\u0E0A\u0E1A\u0E2D\u0E23\u0E4C\u0E14</span>`);
            } else {
              return [
                createVNode(unref(Icon), {
                  icon: "fluent:grid-24-regular",
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<span class="font-semibold" data-v-7a503094${_scopeId}>\u0E1F\u0E35\u0E14\u0E02\u0E48\u0E32\u0E27</span>`);
            } else {
              return [
                createVNode(unref(Icon), {
                  icon: "fluent:chat-bubbles-question-24-regular",
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<span class="font-semibold" data-v-7a503094${_scopeId}>\u0E42\u0E23\u0E07\u0E40\u0E23\u0E35\u0E22\u0E19</span>`);
            } else {
              return [
                createVNode(unref(Icon), {
                  icon: "mdi:school-outline",
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<span class="font-semibold" data-v-7a503094${_scopeId}>\u0E04\u0E2D\u0E23\u0E4C\u0E2A\u0E40\u0E23\u0E35\u0E22\u0E19</span>`);
            } else {
              return [
                createVNode(unref(Icon), {
                  icon: "fluent:book-24-regular",
        ...
        _push(`<div data-v-7a503094><button class="${ssrRenderClass([
        ...
        ])}" data-v-7a503094><div class="flex items-center gap-3" data-v-7a503094>`);
        _push(ssrRenderComponent(unref(Icon), {
          icon: "fluent:wallet-24-regular",
          class: "w-5 h-5"
        }, null, _parent));
        _push(`<span class="font-semibold" data-v-7a503094>\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49</span></div>`);
        _push(ssrRenderComponent(unref(Icon), {
        ...
        if (isEarnMenuOpen.value) {
          _push(`<div class="ml-4 mt-1 space-y-1 border-l-2 border-vikinger-purple/30 pl-3" data-v-7a503094><!--[-->`);
            ...
            _push(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  ...
                  _push2(`<span data-v-7a503094${_scopeId}>${ssrInterpolate(sub.name)}</span>`);
                } else {
                  return [
                    createVNode(unref(Icon), {
                      icon: sub.icon,
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<span class="font-semibold" data-v-7a503094${_scopeId}>\u0E01\u0E32\u0E23\u0E41\u0E08\u0E49\u0E07\u0E40\u0E15\u0E37\u0E2D\u0E19</span>`);
            } else {
              return [
                createVNode(unref(Icon), {
                  icon: "fluent:alert-24-regular",
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          class: [
            "flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-300",
            unref(route).path.startsWith("/play/games") ? "bg-gradient-vikinger text-white shadow-vikinger" : isDarkMode.value ? "text-gray-300 hover:bg-vikinger-purple/10 hover:text-vikinger-cyan" : "text-gray-700 hover:bg-gray-100 hover:text-vikinger-purple"
          ]
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<span class="font-semibold" data-v-7a503094${_scopeId}>\u0E40\u0E01\u0E21\u0E2A\u0E4C</span>`);
            } else {
              return [
                createVNode(unref(Icon), {
                  icon: "fluent:game-24-regular",
                ...
                createVNode("span", { class: "font-semibold" }, "\u0E40\u0E01\u0E21\u0E2A\u0E4C")
              ];
            }
          }),
          _: 1
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<span class="font-semibold" data-v-7a503094${_scopeId}>\u0E15\u0E31\u0E49\u0E07\u0E04\u0E48\u0E32</span>`);
            } else {
              return [
                createVNode(unref(Icon), {
                  icon: "fluent:settings-24-regular",
        ...
        _push(`<div class="p-3 space-y-2 flex flex-col items-center" data-v-7a503094>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/profile",
          class: "mb-4"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img${ssrRenderAttr("src", authUser.value.profile_photo_url)} class="w-12 h-12 rounded-full border-2 border-vikinger-purple shadow-lg"${ssrRenderAttr("alt", authUser.value.name)} data-v-7a503094${_scopeId}>`);
            } else {
              return [
                createVNode("img", {
                  src: authUser.value.profile_photo_url,
      ...
      ])}" data-v-7a503094><div class="max-w-6xl mx-auto px-4 py-6" data-v-7a503094>`);
      if (_ctx.$slots.hero) {
        _push(`<div class="w-full mb-6" data-v-7a503094>`);
        ssrRenderSlot(_ctx.$slots, "hero", {}, null, _push, _parent);
        _push(`</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="grid grid-cols-1 lg:grid-cols-12 gap-6" data-v-7a503094>`);
      if (_ctx.$slots.leftWidgets) {
        _push(`<div class="hidden lg:block lg:col-span-3 space-y-4" data-v-7a503094>`);
      ...
      if (isRightDrawerOpen.value) {
        _push(`<div class="p-6 space-y-6" data-v-7a503094><div class="flex items-center justify-between" data-v-7a503094><h3 class="${ssrRenderClass([isDarkMode.value ? "text-white" : "text-gray-900", "text-lg font-bold"])}" data-v-7a503094> \u0E01\u0E23\u0E30\u0E14\u0E32\u0E19\u0E1C\u0E39\u0E49\u0E19\u0E33 </h3><span class="px-2 py-1 rounded-lg bg-vikinger-purple text-white text-[10px] font-bold uppercase tracking-wider" data-v-7a503094>\u0E19\u0E31\u0E01\u0E40\u0E23\u0E35\u0E22\u0E19\u0E22\u0E2D\u0E14\u0E40\u0E22\u0E35\u0E48\u0E22\u0E21</span></div><div class="relative" data-v-7a503094><input type="text" placeholder="\u0E04\u0E49\u0E19\u0E2B\u0E32\u0E2A\u0E21\u0E32\u0E0A\u0E34\u0E01..." class="${ssrRenderClass([
        ...
        if (unref(isGamificationLoading) && !leaderboard.value.length) {
          _push(`<div class="space-y-3 animate-pulse" data-v-7a503094><!--[-->`);
          ssrRenderList(10, (i) => {
            _push(`<div class="flex items-center gap-3 p-2" data-v-7a503094><div class="w-10 h-10 bg-gray-200 dark:bg-vikinger-dark-200 rounded-full" data-v-7a503094></div><div class="flex-1 space-y-2" data-v-7a503094><div class="h-3 bg-gray-200 dark:bg-vikinger-dark-200 rounded w-2/3" data-v-7a503094></div><div class="h-2 bg-gray-200 dark:bg-vikinger-dark-200 rounded w-1/2" data-v-7a503094></div></div></div>`);
          });
          _push(`<!--]--></div>`);
        } else {
          _push(`<div class="space-y-3" data-v-7a503094><!--[-->`);
          ssrRenderList(leaderboard.value, (user, index) => {
            _push(`<div class="${ssrRenderClass([isDarkMode.value ? "hover:bg-vikinger-dark-200" : "hover:bg-gray-100", "flex items-center gap-3 p-2 rounded-lg cursor-pointer transition-colors group"])}" data-v-7a503094><div class="relative" data-v-7a503094><img${ssrRenderAttr("src", getAvatarUrl(user, index))} class="w-10 h-10 rounded-full border-2 border-transparent group-hover:border-vikinger-purple transition-colors bg-white object-cover" data-v-7a503094><div class="${ssrRenderClass([[
              getRankColor(index),
              isDarkMode.value ? "border-vikinger-dark-100" : "border-white"
            ], "absolute -top-1 -left-1 w-5 h-5 rounded-full border-2 flex items-center justify-center text-[10px] font-bold text-white shadow-sm"])}" data-v-7a503094>${ssrInterpolate(index + 1)}</div></div><div class="flex-1 min-w-0" data-v-7a503094><div class="${ssrRenderClass([isDarkMode.value ? "text-white" : "text-gray-900", "text-sm font-semibold truncate"])}" data-v-7a503094>${ssrInterpolate(user.name)}</div><div class="flex items-center gap-3 mt-1" data-v-7a503094><div class="flex items-center gap-1 text-[10px] font-bold text-vikinger-purple" title="\u0E41\u0E15\u0E49\u0E21\u0E2A\u0E30\u0E2A\u0E21 (PP)" data-v-7a503094><img${ssrRenderAttr("src", _imports_1)} class="w-3.5 h-3.5" alt="pp" data-v-7a503094> ${ssrInterpolate(formatNumber(user.points || 0))}</div></div></div><div class="shrink-0 group-hover:scale-110 transition-transform" data-v-7a503094>`);
            _push(ssrRenderComponent(unref(Icon), {
              icon: "fluent:star-24-filled",
          ...
          if (!leaderboard.value.length) {
            _push(`<div class="text-center py-4 text-gray-500 dark:text-gray-400 text-xs" data-v-7a503094> \u0E22\u0E31\u0E07\u0E44\u0E21\u0E48\u0E21\u0E35\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E25\u0E33\u0E14\u0E31\u0E1A </div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
      ...
      if (!isRightDrawerOpen.value) {
        _push(`<div class="p-2 pt-6 space-y-3 flex flex-col items-center" data-v-7a503094><!--[-->`);
        ssrRenderList(leaderboard.value.slice(0, 10), (user, index) => {
          _push(`<div class="relative cursor-pointer transition-transform hover:scale-110 group"${ssrRenderAttr("title", `Rank ${index + 1}: ${user.name}`)} data-v-7a503094><img${ssrRenderAttr("src", getAvatarUrl(user, index))} class="w-11 h-11 rounded-full border-2 border-transparent group-hover:border-vikinger-purple transition-colors bg-white object-cover" data-v-7a503094><div class="${ssrRenderClass([[
            getRankColor(index),
            isDarkMode.value ? "border-vikinger-dark-100" : "border-white"
          ], "absolute -top-1 -left-1 w-5 h-5 rounded-full border-2 flex items-center justify-center text-[9px] font-bold text-white shadow-sm"])}" data-v-7a503094>${ssrInterpolate(index + 1)}</div></div>`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<!---->`);
      ...
      if (isMobileSidebarOpen.value) {
        _push(`<div class="fixed inset-0 z-50 lg:hidden" data-v-7a503094><div class="absolute inset-0 bg-black/50" data-v-7a503094></div><aside class="${ssrRenderClass([isDarkMode.value ? "bg-vikinger-dark-100" : "bg-white", "absolute left-0 top-0 h-full w-80 max-w-[85vw] overflow-y-auto transition-colors duration-300"])}" data-v-7a503094><div class="p-6 space-y-6" data-v-7a503094><button class="${ssrRenderClass([isDarkMode.value ? "hover:bg-vikinger-purple/10" : "hover:bg-gray-100", "absolute top-4 right-4 p-2 rounded-full transition-colors"])}" data-v-7a503094>`);
        _push(ssrRenderComponent(unref(Icon), {
          icon: "mdi:close",
          class: ["w-6 h-6", isDarkMode.value ? "text-gray-300" : "text-gray-700"]
        }, null, _parent));
        _push(`</button><div class="text-center" data-v-7a503094><div class="relative inline-block mb-3" data-v-7a503094><img${ssrRenderAttr("src", authUser.value.profile_photo_url)} class="w-20 h-20 rounded-full mx-auto border-4 border-vikinger-purple" data-v-7a503094><div class="${ssrRenderClass([isDarkMode.value ? "border-vikinger-dark-100" : "border-white", "absolute -bottom-1 -right-1 w-8 h-8 bg-gradient-vikinger rounded-full flex items-center justify-center text-white text-xs font-bold border-2"])}" data-v-7a503094>${ssrInterpolate(authUser.value.level)}</div></div><h3 class="${ssrRenderClass([isDarkMode.value ? "text-white" : "text-gray-900", "text-lg font-bold"])}" data-v-7a503094>${ssrInterpolate(authUser.value.name)}</h3><p class="${ssrRenderClass([isDarkMode.value ? "text-gray-400" : "text-gray-500", "text-sm"])}" data-v-7a503094>${ssrInterpolate(authUser.value.email)}</p></div><div class="${ssrRenderClass([isDarkMode.value ? "border-vikinger-dark-50/30" : "border-gray-200", "flex justify-center gap-6 py-3 border-y"])}" data-v-7a503094><div class="text-center" data-v-7a503094><div class="${ssrRenderClass([isDarkMode.value ? "text-white" : "text-gray-900", "font-bold"])}" data-v-7a503094>${ssrInterpolate(authUser.value.posts)}</div><div class="${ssrRenderClass([isDarkMode.value ? "text-gray-400" : "text-gray-500", "text-xs uppercase"])}" data-v-7a503094>\u0E42\u0E1E\u0E2A\u0E15\u0E4C</div></div><div class="text-center" data-v-7a503094><div class="${ssrRenderClass([isDarkMode.value ? "text-white" : "text-gray-900", "font-bold"])}" data-v-7a503094>${ssrInterpolate(authUser.value.friends)}</div><div class="${ssrRenderClass([isDarkMode.value ? "text-gray-400" : "text-gray-500", "text-xs uppercase"])}" data-v-7a503094>\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E19</div></div><div class="text-center" data-v-7a503094><div class="${ssrRenderClass([isDarkMode.value ? "text-white" : "text-gray-900", "font-bold"])}" data-v-7a503094>${ssrInterpolate(authUser.value.visits)}</div><div class="${ssrRenderClass([isDarkMode.value ? "text-gray-400" : "text-gray-500", "text-xs uppercase"])}" data-v-7a503094>\u0E40\u0E22\u0E35\u0E48\u0E22\u0E21\u0E0A\u0E21</div></div></div><nav class="space-y-1" data-v-7a503094>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/dashboard",
          class: [
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          class: [
            "flex items-center gap-3 px-4 py-3 rounded-lg transition-colors",
            unref(route).path.startsWith("/play/games") ? "bg-gradient-vikinger text-white shadow-vikinger" : isDarkMode.value ? "text-gray-300 hover:bg-vikinger-purple/10" : "text-gray-700 hover:bg-gray-100"
          ]
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
...
const MainLayout = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7a503094"]]);

export { MainLayout as default };
//# sourceMappingURL=main-BqvhuwHD.mjs.map
