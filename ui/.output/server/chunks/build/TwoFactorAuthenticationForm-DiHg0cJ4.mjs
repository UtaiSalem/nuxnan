import { ref, computed, watch, withCtx, unref, createTextVNode, createVNode, createBlock, createCommentVNode, openBlock, withKeys, Fragment, renderList, toDisplayString, reactive, nextTick, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderAttrs, ssrRenderSlot } from 'vue/server-renderer';
import { a as usePage, u as useForm, r as router } from './inertia-vue3-CWdJjaLG.mjs';
import { _ as _sfc_main$2 } from './ActionSection-DgrI_Sk1.mjs';
import { _ as _sfc_main$9 } from './DialogModal-CfsI63S_.mjs';
import { _ as _sfc_main$5 } from './InputError-DhKaE0Xu.mjs';
import { _ as _sfc_main$6 } from './PrimaryButton-D8uKmFqJ.mjs';
import { _ as _sfc_main$7 } from './SecondaryButton-CNmWyvs4.mjs';
import { _ as _sfc_main$4 } from './TextInput-B3Ml7s7p.mjs';
import { _ as _sfc_main$8 } from './DangerButton-B1fbLIbl.mjs';
import { _ as _sfc_main$3 } from './InputLabel-BgPfgEkm.mjs';
import './server.mjs';
import '../_/nitro.mjs';
import 'node:http';
import 'node:https';
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ConfirmsPassword.vue");
          ...
          if (_push2) {
            ...
            if (twoFactorEnabled.value) {
              ...
              if (qrCode.value) {
                ...
                _push2(`</div><div class="mt-4 p-2 inline-block bg-white"${_scopeId}>${(_a = qrCode.value) != null ? _a : ""}</div>`);
                if (setupKey.value) {
                  _push2(`<div class="mt-4 max-w-xl text-sm text-gray-600"${_scopeId}><p class="font-semibold"${_scopeId}> Setup Key: <span${_scopeId}>${(_b = setupKey.value) != null ? _b : ""}</span></p></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (confirming.value) {
            ...
            if (!twoFactorEnabled.value) {
              ...
              _push2(ssrRenderComponent(_sfc_main$1, { onConfirmed: regenerateRecoveryCodes }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    if (recoveryCodes.value.length > 0 && !confirming.value) {
                      _push3(ssrRenderComponent(_sfc_main$7, { class: "me-3" }, {
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/profile/Partials/TwoFactorAuthenticationForm.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=TwoFactorAuthenticationForm-DiHg0cJ4.mjs.map
