...
import { e as appRootTag, f as appRootAttrs, b as buildAssetsURL, u as useRuntimeConfig, h as getResponseStatusText, i as getResponseStatus, j as appId, k as decodePath, l as defineRenderHandler, p as publicAssetsURL, m as appTeleportTag, n as appTeleportAttrs, a as getQuery, c as createError, o as appHead, q as getRouteRules, s as joinURL, t as useNitroApp } from '../_/nitro.mjs';
...
// @ts-expect-error file will be produced after app build
const getPrecomputedDependencies = () => import('../build/client.precomputed.mjs').then(function (n) { return n.c; }).then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
