          ...
          <div v-if="availableGroups && availableGroups.length > 0">
             ...
             <div class="flex flex-wrap gap-3">
                <button
                    ...
                    class="min-h-[44px] sm:min-h-0 flex items-center gap-2 px-4 py-2 rounded-lg border transition-all duration-200"
                    :class="[
              ...
              <div v-for="(preview, idx) in imagePreviews" :key="idx" class="relative group aspect-video bg-gray-100 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700">
                ...
                <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                    <button
                        ...
                        class="min-h-[44px] sm:min-h-0 min-w-[44px] sm:min-w-0 inline-flex items-center justify-center p-2 bg-red-500 text-white rounded-full hover:bg-red-600 transition-colors"
                    >
