        ...
        try {
            ...
            if(response.success){
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'โพสต์สำเร็จ',
                    text: response.message || 'สร้างโพสต์สำเร็จแล้ว',
                });
                emit('add-new-post-activity', response.activity);
                ...
                Swal.fire({
                    ...
                    text: response.message || 'ไม่สามารถสร้างโพสต์ได้',
                });
            }
            ...
            Swal.fire({
                icon: 'error',
                title: 'เกิดข้อผิดพลาด',
                text: error?.data?.message || 'ไม่สามารถสร้างโพสต์ได้ กรุณาลองใหม่อีกครั้ง',
            });
        }
