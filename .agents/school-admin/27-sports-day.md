...
| **S-S7** | อัลบั้มภาพผูกกับงาน (ต้องเพิ่ม owner ให้ `albums` หรือทำตารางใหม่ — ดู §1.3) | S-S6b | 🟡 **backend เสร็จ 2026-08-20** — ตารางใหม่ `sports_albums`/`sports_photos` + 9 route + ย่อรูปจริง (13 เทสต์) ดู §12.10 · **หน้าจอยังไม่ได้ทำ** |
