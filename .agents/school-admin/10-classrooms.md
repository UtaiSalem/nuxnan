...
| CL-S7 | G6 — phase-6 legacy column drop | (แยกโปรเจค) | ดูแผนแบ่งเฟส [`.agents/legacy-class-columns-drop-plan.md`](../legacy-class-columns-drop-plan.md) | 🔵 **แผนพร้อม 2026-09-15** — scope จริง ~263 จุด/56 ไฟล์ · แบ่ง 7 เฟส (A audit→B accessor→C SQL→D write→E drop→F FE→G cleanup) · รอเคาะเริ่ม Phase A |
