...
| CL-S7 | G6 — phase-6 legacy column drop | (แยกโปรเจค) | ดูแผน [`.agents/legacy-class-columns-drop-plan.md`](../legacy-class-columns-drop-plan.md) | 🟢 **ปิดงาน 2026-09-16 ที่ Phase B/C** — A audit ✅ · B accessor `43bdeb69` (อ่านจาก enrollment + normalize) ✅ · C ลบ dead fallback ✅ · **D/E/F/G ยกเลิก** เพราะ R4: คอลัมน์ยังทำหน้าที่ **intake staging** ของ rollover (เด็กใหม่รอเข้าเรียน) ที่ enrollment ตอบแทนไม่ได้ · ได้ผลจริง: data drift หาย แม้ไม่ได้ drop |
