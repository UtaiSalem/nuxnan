...
| shard | ขอบเขต | ส่งให้ |
|---|---|---|
| **E-S9a** | backend G1 + G2 (+ เทสต์) | codex |
| **E-S9b** | ขยาย `useElections.ts` + `index.vue` + เมนูใน `admin.vue` | agy/codex |
| **E-S9c** | `[id].vue` + แท็บ ภาพรวม/พรรค/บัญชีผู้มีสิทธิ์ | agy/codex |
