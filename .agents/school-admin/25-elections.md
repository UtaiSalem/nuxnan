...
| **E-S9c2** | **ทำ 3 แท็บให้ใช้งานได้จริง** ตาม §11.11 — filter/pagination ที่ตายอยู่ · สรุปล็อกครบ 10 ตัวเลข + คำเตือน §9.1 · `education_level` ในบัญชีผู้มีสิทธิ์ · ปุ่มแก้ไข/ยกเลิก · งานค้าง C2/C3/C5 | E-S9c | FE + BE เล็กน้อย | ⚪ **งานถัดไป** |
