...
### สถานะ: **ตรวจเสร็จ · ยังไม่ได้แก้โค้ดสักบรรทัด** · สเปกเพิ่ม §15 แล้ว
...
ผู้มีสิทธิ์ 2,193 แถว · บัตร 14 ใบ · คำสั่งล้างอยู่ใน §15.6 ของสเปก

### งานที่ค้างต่อ

- [ ] **แก้ F1 + F2** แล้วเปิดจอตรวจซ้ำทั้ง 6 แท็บ + apply.vue + ปุ่มตั้งสภานักเรียน
