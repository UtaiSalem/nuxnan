...
### สถานะ: D-S1/S2/S3/S6 เสร็จ · push แล้ว (`793f56c5`, `2417eddd`, `4d7b554e`) · **ยังไม่ deploy**
...
- **ยังไม่ควรกดเปิดสิทธิ์ให้ฝ่ายใดจนกว่า D-S4 จะเสร็จ** — สิทธิ์ที่ได้จากฝ่ายยังไม่ถูกจำกัดขอบเขตข้อมูล เปิด `students.view` ให้ฝ่ายไหน สมาชิกฝ่ายนั้นจะเห็นนักเรียนทั้ง 2,931 คน (มีคำเตือนใน docblock ของ middleware แล้ว)
...
- [ ] **D-S4 ขอบเขตข้อมูลของฝ่าย** — สำคัญสุดที่เหลือ เป็นเงื่อนไขก่อนเปิดสิทธิ์ให้ฝ่ายจริง
- [ ] D-S5 audit log · D-S6b ป้ายบอกว่าอยู่ฝ่ายอื่นแล้ว (ต้องเพิ่ม field ใน `members/search`) · D-S7 หน้ารายละเอียดฝ่าย
