...
use App\Http\Controllers\Api\Play\PollController;
use App\Http\Controllers\Api\Play\PollReactionController;
use App\Http\Controllers\Api\Play\PollVoteController;
...
Route::middleware(['auth:api'])->group(function () {
    ...
    Route::post('/polls/{poll}/like', [PollReactionController::class, 'toggleLikePoll'])->name('polls.like');
    Route::post('/polls/{poll}/dislike', [PollReactionController::class, 'toggleDislikePoll'])->name('polls.dislike');
    Route::post('/polls/{poll}/comment', [PollReactionController::class, 'storeComment'])->name('polls.comment');
    Route::patch('/poll_comments/{poll_comment}', [PollReactionController::class, 'updateComment'])->name('polls.comment.update');
    Route::delete('/poll_comments/{poll_comment}', [PollReactionController::class, 'destroyComment'])->name('polls.comment.destroy');
