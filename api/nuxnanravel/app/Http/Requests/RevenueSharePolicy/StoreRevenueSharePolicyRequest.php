...
class StoreRevenueSharePolicyRequest extends FormRequest
{
    ...
    {
        return ['scope_type' => 'required|in:platform,academy,course,campaign', 'scope_id' => 'required_unless:scope_type,platform|nullable|integer', 'student_pct' => 'required|numeric|between:0,100', 'course_pct' => 'required|numeric|between:0,100', 'platform_pct' => 'required|numeric|between:0,100', 'effective_from' => 'required|date', 'effective_to' => 'nullable|date|after:effective_from', 'notes' => 'nullable|string|max:500'];
    }
