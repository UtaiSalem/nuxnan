...
class CartController extends Controller
{
    public function index(Request $request) {
        ...
        $cart = \App\Models\Cart::with(['items.product.postImages'])->firstOrCreate(['user_id' => $user->id]);
    ...
    public function add(Request $request) {
        ...
        $product = \App\Models\Post::find($request->post_id);
    ...
    public function update(Request $request) {
        ...
        $item = \App\Models\CartItem::find($request->item_id);
