...
class CourseResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'max_absence_percent' => $this->max_absence_percent,
            'min_sessions_for_eligibility_check' => $this->min_sessions_for_eligibility_check,
            'allow_unlock_by_appeal' => $this->allow_unlock_by_appeal,
            'allow_unlock_by_points' => $this->allow_unlock_by_points,
            'unlock_points_cost' => $this->unlock_points_cost,
