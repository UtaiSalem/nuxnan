...
class AcademyPointWithdrawalRequest extends Model
{
    use SoftDeletes;
    ...
    protected $fillable = ['academy_id', 'academy_point_account_id', 'requested_by', 'amount', 'purpose', 'status', 'reviewed_by', 'reviewed_at', 'approved_by', 'approved_at', 'paid_by', 'paid_at',     'payment_reference', 'rejection_reason', 'admin_note', 'metadata', 'version', 'idempotency_key', 'academy_point_transaction_id'];

    protected $casts = ['amount' => 'integer',  'metadata' => 'array', 'reviewed_at' => 'datetime', 'approved_at' => 'datetime', 'paid_at' => 'datetime'];
    ...
    {
        return $this->belongsTo(AcademyPointAccount::class, 'academy_point_account_id');
    }
