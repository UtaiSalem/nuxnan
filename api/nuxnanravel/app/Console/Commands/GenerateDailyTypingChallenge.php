...
class GenerateDailyTypingChallenge extends Command
{
    ...
    public function handle(): void
    {
        ...
        TypingDailyChallenge::create([
            ...
            'content_ids'    => $words,
            'target_wpm'     => match($difficulty) { 'easy' => 25, 'normal' => 35, 'hard' => 50, default => 30 },
            'target_acc'     => 85.0,
            'xp_reward'      => match($difficulty) { 'easy' => 30, 'normal' => 60, 'hard' => 100, default => 50 },
            'pp_reward'      => match($difficulty) { 'easy' => 5,  'normal' => 10, 'hard' => 20,  default => 10 },
        ]);
